             ...
             <Subheading heading='Top Job Picks for you'/>
              ...
              <Box>
               {/* shows pagination for jobs */}
                 { 
                   (filteredJobs.length>0 || jobs.length>0 || searchedJobs.length > 0 ) && 
                   <Pagination count={10} color="primary" page={page} onChange={handleChangePage} className={classes.pageBox}/>
                 }        
               </Box>      
           </Box>
        </Grid>
