import { Box, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Avatar, Typography, Stack, Dialog, DialogActions, Button } from "@mui/material";
          ...
          <Link to="/" className={classes.navItem}>
            <ListItem disablePadding>
              ...
              >
                ...
                <ListItemText className={classes.navTxt}>
                  Dashboard
                </ListItemText>
              </ListItemButton>
            </ListItem>
